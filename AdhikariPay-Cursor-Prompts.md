...
>
> This file contains **historical build prompts** from early prototyping. All references to "LokalPay", "Spice Money", or "LokalMart" below are legacy placeholders — the product is **Adhikari Pay**.
...
```
You are setting up a Turborepo monorepo for "LokalPay", a B2B agent fintech platform.
...
PWA. This is the app the shopkeeper uses at the counter (like the Spice Money screen).
