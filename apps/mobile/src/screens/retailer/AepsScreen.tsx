...
const BANKS: Bank[] = [
  { id: "bob", name: "Bank of Baroda", shortName: "BOB", color: "#E64A19", letter: "B" },
  { id: "pnb", name: "Punjab National Bank", shortName: "PNB", color: "#D32F2F", letter: "P" },
  { id: "psb", name: "Punjab & Sind Bank", shortName: "PSB", color: "#7B1FA2", letter: "P" },
  { id: "sbi", name: "State Bank of India", shortName: "SBI", color: "#1565C0", letter: "S" },
  { id: "hdfc", name: "HDFC Bank", shortName: "HDFC", color: "#00338D", letter: "H" },
  { id: "airtel", name: "Airtel Payment Bank", shortName: "Airtel", color: "#E53935", letter: "A" },
  { id: "icici", name: "ICICI Bank", shortName: "ICICI", color: "#F57C00", letter: "I" },
  { id: "pgb", name: "Punjab Gramin Bank", shortName: "PGB", color: "#E91E63", letter: "P" },
  { id: "uco", name: "UCO Bank", shortName: "UCO", color: "#7B1FA2", letter: "U" },
  { id: "boi", name: "Bank of India", shortName: "BOI", color: "#E65100", letter: "B" },
  { id: "canara", name: "Canara Bank", shortName: "Canara", color: "#1976D2", letter: "C" },
  { id: "indian", name: "Indian Bank", shortName: "Indian", color: "#0D47A1", letter: "I" },
  { id: "union", name: "Union Bank of India", shortName: "Union", color: "#F57C00", letter: "U" },
  { id: "kotak", name: "Kotak Mahindra Bank", shortName: "Kotak", color: "#E53935", letter: "K" },
  { id: "axis", name: "Axis Bank", shortName: "Axis", color: "#6A1B9A", letter: "A" },
  { id: "iob", name: "Indian Overseas Bank", shortName: "IOB", color: "#C62828", letter: "I" },
  { id: "central", name: "Central Bank of India", shortName: "Central", color: "#B71C1C", letter: "C" },
  { id: "bom", name: "Bank of Maharashtra", shortName: "BOM", color: "#4A148C", letter: "B" },
  { id: "idbi", name: "IDBI Bank", shortName: "IDBI", color: "#00695C", letter: "I" },
  { id: "yes", name: "Yes Bank", shortName: "Yes", color: "#1565C0", letter: "Y" },
  { id: "fino", name: "Fino Payments Bank", shortName: "Fino", color: "#FF6F00", letter: "F" },
  { id: "paytm", name: "Paytm Payments Bank", shortName: "Paytm", color: "#00BCD4", letter: "P" },
];
...
export function AepsScreen({ onBack, initialTab, serviceCode }: AepsScreenProps) {
  ...
  const canScan = !!selectedBank && aadhaar.length >= 8 && consent;
      ...
      >
        ...
        <View style={[s.card, { backgroundColor: tokens.card, borderColor: tokens.cardBorder }]}>
          ...
          <Pressable
            ...
            style={({ pressed }) => [s.scanBtn, (!canScan || scanning) && s.scanBtnDisabled, pressed && { opacity: 0.85 }]}
          >
            <LinearGradient
              colors={canScan && !scanning ? [colors.greenLight, colors.greenDark] : ["#94a3b8", "#94a3b8"]}
              start={gradientDirection.diagonal.start}
              end={gradientDirection.diagonal.end}
            ...
            >
              ...
              <Text style={s.scanBtnText}>
                {scanning ? "Scanning..." : authMode === "fingerprint" ? "Scan Finger" : "Scan Iris"}
              </Text>
            </LinearGradient>
          </Pressable>
        </View>
