...
export function AdhikariIcon({ size = 36 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="52 52 228 228" fill="none" aria-hidden>
      <defs>
        <linearGradient id="ib2" x1="60" y1="50" x2="280" y2="282" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#2A5CDD" />
          <stop offset="1" stopColor="#0B2A9A" />
        </linearGradient>
        <linearGradient id="iw2" x1="90" y1="120" x2="240" y2="252" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#24CC82" />
          <stop offset="1" stopColor="#11A362" />
        </linearGradient>
      </defs>
      <rect x="52" y="52" width="228" height="228" rx="62" fill="url(#ib2)" />
      <rect x="120" y="110" width="96" height="30" rx="8" fill="#fff" opacity="0.38" />
      <rect x="94" y="130" width="144" height="112" rx="26" fill="url(#iw2)" />
