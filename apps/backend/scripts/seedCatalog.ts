...
const CATALOG: SeedCategory[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { code: "MOBILE_POSTPAID", name: "Mobile Postpaid", badge: "Flat ₹2" },
      { code: "DTH", name: "DTH", badge: "Upto 1.50%", icon: "DTH.svg" },
      { code: "CABLE_TV", name: "Cable TV", badge: "Flat ₹2", icon: "Cable-Tv.svg" },
      { code: "LANDLINE_POSTPAID", name: "Landline Postpaid", badge: "Flat ₹2" },
      { code: "BROADBAND_POSTPAID", name: "Broadband Postpaid", badge: "Flat ₹2" },
